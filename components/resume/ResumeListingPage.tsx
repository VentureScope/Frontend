          ...
          <div className="mt-8 space-y-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 p-4 sm:p-6">
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between gap-2">
                        <div>
                          ...
                          <p className="text-sm text-slate-600">
                            {mockResumes[0].company}
                          </p>
                          <p className="text-xs text-slate-500 mt-1">
                            Last updated {mockResumes[0].lastUpdated}
                          </p>
                          {mockResumes[0].tags.length > 0 && (
                            <p className="text-xs text-slate-600 mt-2">
                              {mockResumes[0].tags[0]}
                            </p>
                          )}
                        </div>
                      ...
                      <div className="mt-4 flex gap-3">
                        <button className="flex-1 rounded-lg border border-slate-300 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-50 transition-colors">
                          View
                        </button>
            ...
            <div className="mt-8">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {mockResumes.slice(1).map((resume) => (
                  <div
                    key={resume.id}

...
const WORKFLOW_ITEMS: WorkflowItem[] = [
  { id: "personal", icon: <User size={20} />, label: "Personal Information", completed: true },
  { id: "experience", icon: <Briefcase size={20} />, label: "Professional Experience", completed: true },
  { id: "education", icon: <GraduationCap size={20} />, label: "Academic History", completed: false },
  { id: "projects", icon: <Layers size={20} />, label: "Portfolio Projects", completed: false },
];
...
export default function Step3Editor() {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-50 overflow-hidden">
      {/* Header */}
      <div className="sticky top-0 z-40 bg-white border-b border-slate-100 px-4 sm:px-6 lg:px-8 py-4">

  ...
  return (
    <>
      ...
      >
        <div className="flex items-center justify-between p-6">
          ...
          >
            ...
            <div>
              ...
              <p className="text-label mt-1.5 text-muted-foreground">
                Intelligence Layer
              </p>
            </div>
          </Link>
        ...
        <nav className="custom-scrollbar flex-1 space-y-6 overflow-y-auto px-3 pb-4">
                  ...
                  return (
                    <li key={item.name}>
                      <Link
                        ...
                        onClick={onClose}
                        className={cn(
                          "flex w-full items-center gap-3 rounded-md border-l-2 py-2.5 pl-3 pr-3 text-btn transition-colors",
                          active
        ...
        <div className="border-t border-border p-4">
          <button
            ...
            className="text-btn flex w-full items-center justify-center gap-2 rounded-md border border-border bg-transparent py-2.5 font-medium text-muted-foreground transition-colors hover:bg-muted hover:text-foreground disabled:opacity-60"
          >

...
export default function InsightCard() {
  return (
    <div className="vs-surface flex min-h-75 flex-col justify-between p-6 sm:p-8 lg:min-h-0 lg:p-10">
      ...
      <Link
        ...
        className="text-btn mt-8 flex w-fit items-center gap-2 font-medium text-muted-foreground transition-colors hover:text-foreground lg:mt-0"
      >

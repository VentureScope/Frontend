  ...
  return (
    <div className="flex flex-col justify-between rounded-3xl sm:rounded-[40px] bg-[#b0002d] p-6 sm:p-8 lg:p-10 text-white shadow-xl shadow-rose-900/10 min-h-75 lg:min-h-0">
      <div className="space-y-4 sm:space-y-6">
        <div className="inline-flex w-fit items-center gap-2 rounded-full bg-card/20 px-3 py-1.5 sm:px-4 text-[9px] sm:text-[10px] font-bold uppercase tracking-widest backdrop-blur-md">

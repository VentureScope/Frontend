    ...
    <div className="grid grid-cols-1 gap-4 sm:gap-6 lg:grid-cols-3">
      <div className="vs-surface p-6 sm:p-8">
        <div className="mb-6 flex items-center justify-between sm:mb-8">
          <div className="rounded-md bg-muted p-2.5 text-muted-foreground sm:p-3">
            <BookOpen className="h-5 w-5 sm:h-6 sm:w-6" />
          </div>
          <span className="text-label text-muted-foreground">Active Module</span>
        </div>
      ...
      <div className="vs-surface p-6 sm:p-8">
        ...
        <div className="relative">
          <input
            ...
            className="text-body w-full rounded-md border border-border bg-muted py-3.5 pr-12 pl-4 text-foreground outline-none placeholder:text-muted-foreground focus:ring-1 focus:ring-ring/20 sm:py-4"
          />
          <Send className="absolute top-1/2 right-4 h-4 w-4 -translate-y-1/2 cursor-pointer text-muted-foreground sm:right-5" />
        </div>
      </div>
      ...
      <div className="vs-surface p-6 sm:p-8">
        <div className="mb-6 flex items-center justify-between sm:mb-8">
          ...
          <div className="text-right">
            ...
            <p className="text-lg font-semibold text-foreground sm:text-xl">92%</p>
          </div>
        </div>

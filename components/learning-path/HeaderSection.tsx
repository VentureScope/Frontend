  ...
  return (
    <div className="flex flex-col justify-between gap-6 md:flex-row md:items-start">
      <div className="space-y-4">
        ...
        <h1 className="text-h1 text-foreground">Learning Paths</h1>
      ...
      <Button
        asChild
        className="h-12 gap-2 rounded-lg bg-primary px-8 font-medium text-primary-foreground  transition-all hover:bg-primary/90"
      >

...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-linear-to-b from-muted/50 via-background to-background pb-20 pt-20 lg:pb-32 lg:pt-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid items-center gap-16 lg:grid-cols-2">
          <div className="space-y-8">
            <div className="inline-flex items-center gap-2 rounded-md border border-border bg-muted px-4 py-1.5 text-[10px] font-bold uppercase tracking-widest text-muted-foreground">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold leading-[1.1] tracking-tight text-foreground">
              ...
              <span className="underline decoration-muted-foreground/25 decoration-4 underline-offset-4 sm:decoration-8 sm:underline-offset-8">
                Ethiopia.
              </span>
            </h1>
          ...
          <div className="relative mx-auto w-full max-w-135 lg:mr-0">
            <div
              className="absolute -inset-4 rounded-xl bg-linear-to-tr from-muted/30 to-transparent blur-2xl"
              aria-hidden
            />

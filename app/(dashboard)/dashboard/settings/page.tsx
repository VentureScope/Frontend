        ...
        async function onDeleteAccount() {
          ...
          try {
            ...
            toast.error("Deletion Failed", {
              description:
                error?.message ||
                "Failed to delete account. Incorrect password?",
            });
          }
                ...
                <header className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
                  ...
                  <div className="flex gap-4">
                    <Button
                      ...
                      disabled={
                        activeTab !== "profile" || form.formState.isSubmitting
                      }
                      variant="outline"
                        ...
                        <div className="rounded-[40px] bg-white p-10 shadow-sm border border-slate-100">
                          <div className="flex flex-col gap-10 md:flex-row md:items-center mb-12">
                            ...
                            <div className="space-y-2">
                              ...
                              <p className="text-slate-400 max-w-sm leading-relaxed">
                                This data informs your market alignment scores
                                and career-fit recommendations.
                              </p>
                            </div>
                          </div>
                          ...
                          >
                            ...
                            <Field>
                              ...
                              <FieldError
                                errors={[form.formState.errors.portfolio]}
                              />
                            </Field>
                          </form>
                        </div>
                          ...
                          <div className="flex items-center gap-8">
                            ...
                            <div>
                              ...
                              <p className="text-slate-400 font-medium">
                                All data hooks are currently optimized and
                                active.
                              </p>
                            </div>
                          </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                          <div className="rounded-[40px] border-2 border-blue-100 bg-white p-10 flex flex-col justify-between h-72">
                            ...
                            <div className="space-y-2">
                              ...
                              <p className="text-sm text-slate-400 leading-relaxed">
                                Mapping repositories and commit patterns to
                          ...
                          <div className="rounded-[40px] border border-slate-100 border-dashed bg-white p-10 flex flex-col justify-between h-72 opacity-60 transition-opacity hover:opacity-100">
                            ...
                            <div className="space-y-4">
                              ...
                              <p className="text-sm text-slate-400 leading-relaxed">
                                Authorized academic portals to verify degrees
                                and GPA scores.
                              </p>
                              ...
                              <div className="flex justify-between items-end">
                                <div>
                                  ...
                                  <p className="text-sm text-slate-400 max-w-sm">
                                    How aggressive should AI be in suggesting
                                    high-risk pivots?
                                  </p>
                                </div>
                          ...
                          <div className="relative z-10 space-y-10">
                            <div className="space-y-4">
                              ...
                              <p className="text-slate-400 text-lg leading-relaxed max-w-2xl">
                                ...
                                being mapped to global trend analysis.
                              </p>
                            </div>
                            ...
                            <div className="flex items-center gap-6 text-rose-600">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-rose-400 font-medium italic">
                                  Permanently delete all synced intelligence
                                  sources.
                                </p>
                              </div>
                            </div>
                          ...
                          <div className="relative z-10 flex flex-col justify-between gap-12 md:flex-row md:items-center">
                            <div className="space-y-6">
                              ...
                              <p className="text-blue-100/80 text-lg leading-relaxed max-w-sm">
                                Unlimited AI Advisor access, real-time Ethiopia
                                market maps, and automated career pathing.
                              </p>
                            </div>
                            <div className="text-right space-y-2">
                              <p className="text-7xl font-black tracking-tighter">
                                $29
                                <span className="text-2xl text-blue-200/50">
                                  /mo
                                </span>
                              </p>
